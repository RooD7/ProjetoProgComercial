...
procedure TfrmGrupoProd.Popula_Grid;
  ...
  Begin
    ...
    if Not(btnAZ.Enabled)
      then GruposP_Atuais := Retorna_GrupoProds_Cadastrados(Campo, Termo, 'AZ');
    if Not(btnZA.Enabled)
      then GruposP_Atuais := Retorna_GrupoProds_Cadastrados(Campo, Termo, 'ZA');
    if Not(btn09.Enabled)
      then GruposP_Atuais := Retorna_GrupoProds_Cadastrados(Campo, Termo, '09');
    if Not(btn90.Enabled)
      then GruposP_Atuais := Retorna_GrupoProds_Cadastrados(Campo, Termo, '90');
    If Length(GruposP_Atuais) >= 1
      Then sgdGrupoProd.RowCount := Length(GruposP_Atuais)+1
      Else Begin
           ...
           End;
    lblQtde.Caption := IntToStr(Length(GruposP_Atuais))+ ' grupos de produtos cadastrados';
...
procedure TfrmGrupoProd.sgdGrupoProdSelectCell(Sender: TObject; ACol,
