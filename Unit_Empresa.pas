...
Application.MessageBox('O campo de endereço é obrigatório',
    ...
    if Not(isCNPJ(Temp_CNPJ))
      Then Begin
Application.MessageBox('O CNPJ é inválido. Digite o CNPJ correto e tente novamente!',
                       'CNPJ incorreto',
                       MB_ICONERROR+MB_OK);
             Result := False;
             PageControl1.ActivePageIndex := 0;
