      ...
      if RadioButton_Vista.Checked then
        ...
        msg:='Compra a vista';
          ...
          //cupomfiscal
             ...
             // Dá Acréscimo ou Desconto em Item posterior
             cNumeroItem := '001';
             cDescAcresc := 'A';
             cTipo := '$';
             cValor := '10,00';
             ...
             // Cancela Acréscimo ou Desconto em Item Vendido Posterior
             cDescAcresc := 'A';
             cNumeroItem := '001';
             ...
             // Inicia o Fechamento do Cupom Fiscal com Acréscimo e/ou Desconto
             cDescAcresc := 'X';
             cTipo := '$';
             cValorDesc := '05,00';
             cValorAcre := '10,00';
        ...
        if np>6 then
        begin
           ShowMessage('É possivel parcelar em apenas até 6 vezes');
           np:= strtoint(InputBox('Gaveta Caixa', 'Numero de parcelas : ', ''));
        end;
