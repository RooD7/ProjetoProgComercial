...
Begin
  ...
  Begin
    Application.MessageBox('O campo de Inscrição Estadual é obrigatório',
      'Informe a inscrição', MB_ICONERROR + MB_OK);
    Result := False;
    PageControl1.ActivePageIndex := 0;
  ...
  Begin
    Application.MessageBox('O campo UF é obrigatório',
  ...
  Begin
    Application.MessageBox('O campo de telefone do responsável é obrigatório',
      'Informe o telefone do responsável', MB_ICONERROR + MB_OK);
    Result := False;
    PageControl1.ActivePageIndex := 0;
